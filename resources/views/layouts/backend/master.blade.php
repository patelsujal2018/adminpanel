...
<head>
    ...
    <title>{{$companydata->company_name}} | @yield('page_title')</title>
    ...
    <link rel='shortcut icon' href="{{ url('backend/uploads/company') }}/{{$companydata->company_favicon_icon}}" type='image/png' />
